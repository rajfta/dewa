...
A berendezés tervezése során kiemelt szempont volt, hogy minden alkatrész és egység könnyen hozzáférhető és egyszerűen cserélhető legyen. Minden csatlakozás szabadon elérhető, így az esetleges alkatrészcserék vagy karbantartások rövid idő alatt, kényelmesen elvégezhetők. Ez jelentősen csökkenti a leállási időket és növeli a termelés hatékonyságát.
...
A Sames új berendezése nem egyszerűen egy új eszköz, hanem egy komplett rendszer, amely a modern gyártás minden elvárására választ ad. Kényelmesebb, gyorsabb, okosabb – és teljes mértékben az Ön igényeire szabható. Ez több, mint egy gép, ez a festéstechnológia új generációja!
